    ...
    if (file_exists($filename)) {
        ...
        while ($row = fgets($file)) {
            ...
            if (isset($rowdata[1]) and $i > 0) {
                ...
                $volume = retornaValorInteiro($rowdata[23]);
                ...
                $stmt = $conn->prepare("insert into tbl_agressao(nm_papel,ds_variacao,dt_operacao,hr_operacao,vl_abertura,vl_maxima,vl_minima,vl_fechamento,vl_saldo,vl_volume,vl_ema_9)" .
                    "values(:nm_papel,:ds_variacao,:dt_operacao,:hr_operacao,:vl_abertura,:vl_maxima,:vl_minima,:vl_fechamento,:vl_saldo,:vl_volume,:vl_ema_9)");
                ...
                $stmt->bindParam(":vl_volume", $volume);
